...
#define MSM_PMEM_MDP_BASE			0x41500000
#define MSM_PMEM_MDP_SIZE				0xC00000 
#define MSM_ION_AUDIO_BASE			0x42100000
...
#define MSM_ION_WB_SIZE		0xC00000 /* 12MB */ // (MSM_FB_OVERLAY0_WRITEBACK_SIZE)
...
#endif
#ifdef CONFIG_GYRO_K3G
// TEMP	&gyro_i2c_gpio_device,
#endif
#ifdef CONFIG_CMC623_P5LTE
	&cmc623_i2c_gpio_device,
#endif
#ifdef CONFIG_SAMSUNG_JACK
// TEMP	&sec_device_jack,
#endif
...
// TEMP extern int charm_ready;
// TEMP extern int mdm_bootloader_done;
...
// TEMP	if (( status == 0 ) && ( mdm_bootloader_done && !charm_ready )){
	if ( status == 0 ) {
...
#ifdef CONFIG_SENSORS_AK8975
// TEMP	magnetic_device_init();
#endif
#ifdef CONFIG_GYRO_K3G
// TEMP	gyro_device_init();
#endif
#ifdef CONFIG_OPTICAL_GP2A
